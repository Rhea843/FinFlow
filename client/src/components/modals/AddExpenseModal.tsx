...
const AddExpenseModal = ({ onClose, onSuccess }: Props) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white dark:bg-[#0F172A] border border-[#3a6ea5] rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.3)] w-full max-w-md mx-4 p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-[#2e2e2e] dark:text-[#fafafa]">Add Expense</h3>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className='relative'>
            ...
            <input
              ...
              value={form.amount}
              onChange={handleChange}
              className="w-full border border-[#3A6EA5] dark:border-[#3A6EA5] rounded-md px-6 py-3 text-sm outline-none focus:border-red-400 transition-colors bg-transparent text-[#2e2e2e] dark:text-[#fafafa]"
           />
          </div>
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 bg-red-500 text-white py-3 rounded-lg text-sm font-medium hover:bg-red-600 transition-colors disabled:opacity-60"
          >
