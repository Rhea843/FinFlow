...
const Register = () => {
  ...
  return (
    <div className="min-h-screen pt-[90px] relative" style={{
      background: `
      linear-gradient(
        240deg,
        rgba(58,110,165,1) 0%,
     ...
     `,
      ...
      <div className="bg-[#E9F1FA] min-h-[calc(100vh-90px)] md:rounded-tr-[183px] rounded-tr-[60px] py-4 flex flex-col items-center justify-center">
        ...
        <h1 className="md:text-3xl text-2xl font-bold text-[#3A6EA5] mb-4 text-center">Create an account</h1>
        ...
        <div className='bg-white md:max-w-2xl max-w-xs mx-auto rounded-2xl shadow-[0_2px_4px_rgba(0,0,0,0.3)] px-6 md:px-12 py-6'>
         ...
         <div className="flex items-center gap-3 mb-4 w-full">
            ...
            <span className="text-[#2e2e2e] text-sm whitespace-nowrap">Or sign up with</span>
            <hr className="flex-1 border-[#2e2e2e]" />
         </div>
         ...
         {/* form fields */}
          <div className="flex flex-col gap-4 w-full">
            ...
            <div>
              <label className="text-sm text-[#2e2e2e] mb-1 block">Full name</label>
              <input
                type="text"
                name="name"
          ...
          <div className="flex items-start gap-2 text-sm text-[#2e2e2e] cursor-pointer">
            <input
              type="checkbox"
              checked={agreed}
            ...
            />
            By proceeding, you agree to the terms and conditions, and our privacy policy.
          </div>
