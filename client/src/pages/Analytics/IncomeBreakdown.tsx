...
const IncomeBreakdown = ({ transactions }: Props) => {
   ...
   <div className="bg-white dark:bg-[#0F172A] rounded-xl p-6 border border-[#3a6ea5]/70 shadow-[0_4px_4px_rgba(0,0,0,0.3)]">
    <div className="flex flex-col items-center">
     <div className="flex items-center justify-between mb-2">
        <h3 className="font-semibold text-[#2e2e2e] dark:text-[#fafafa]">Income Breakdown</h3>
      </div>

       <p className="text-xs text-slate-400 mb-3">{dateLabel()}</p>

      {/* filter */}
      <div className="flex items-center gap-1 bg-[#3a6ea5]/20 dark:bg-slate-800 rounded-lg p-1 mb-4 w-fit">
